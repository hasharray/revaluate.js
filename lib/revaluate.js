      ...
      if (index in __cache) {
        ...
        Object.defineProperty(__cache, index, {
          get: function() {
            ...
            return (__cache[index] = reassign(target, source, true));
          }
        });
      }
      ...
      if (index in __cache) {
        ...
        Object.defineProperty(__cache, index, {
          get: function() {
            ...
            return (__cache[index] = reassign(target, source, false));
          },
        })
      }
...
function reassign(target, source, prototype) {
  ...
  if (prototype) {
    reassign(target.prototype, source.prototype);
  }
