      ...
      if (index in __cache) {
        ...
        Object.defineProperty(__cache, index, {
          get: function() {
            ...
            var prototype = false;
            do {
              var names = Object.getOwnPropertyNames(prototype ? source.prototype : source);
              for (var i = 0; i < names.length; i++) {
                ...
                Object.defineProperty(prototype ? target.prototype : target, name, descriptor);
              }

              prototype = prototype ? null : true;
            } while (prototype);
